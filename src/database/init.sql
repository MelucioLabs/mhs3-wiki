...
('Großer Izuchi', 'Great Izuchi', 'none', 'speed', 'jump', 'Canalta-Waldland', 'Canalta Timberland', 'Der Anführer eines Izuchi-Trios. Greift mit seinem sichelförmigen Schwanz an.', 'The leader of an Izuchi trio. Attacks with its sickle-shaped tail.'),
...
('Purpur-Gypceros', 'Purple Gypceros', 'none', 'power', 'fly', 'Azuria', 'Azuria', 'Eine giftigere Variante des Gypceros mit violetter Färbung und stärkerem Gift.', 'A more venomous variant of Gypceros with purple coloring and stronger poison.'),
...
('Einauge Yian Garuga', 'Deadeye Yian Garuga', 'none', 'power', 'fly', 'Canalta-Waldland', 'Canalta Timberland', 'Eine abweichende Form des Yian Garuga. Noch aggressiver und mit stärkerem Gift.', 'A deviant form of Yian Garuga. Even more aggressive with stronger poison.'),
...
('Blutorange Bishaten', 'Blood Orange Bishaten', 'fire', 'technical', 'fly, climb', 'Tarkuan', 'Tarkuan', 'Eine Unterart des Bishaten die mit explosiven Früchten angreift und Sprengschaden verursacht.', 'A subspecies of Bishaten that attacks with explosive fruits dealing blast damage.'),
...
('Schemen-Nerscylla', 'Shrouded Nerscylla', 'none', 'technical', 'climb', 'Serathis', 'Serathis', 'Eine Unterart der Nerscylla mit stärkerer Giftfähigkeit und dichteren Fäden.', 'A subspecies of Nerscylla with stronger poison capability and denser webs.'),
...
('Fulguranjanath', 'Fulgur Anjanath', 'thunder', 'power', 'jump', 'Canalta-Waldland', 'Canalta Timberland', 'Eine Unterart des Anjanath die Blitzenergie statt Feuer nutzt.', 'A subspecies of Anjanath that uses thunder energy instead of fire.'),
...
('Höllenschneide Glavenus', 'Hellblade Glavenus', 'fire', 'speed', 'jump', 'Tarkuan', 'Tarkuan', 'Eine abweichende Form des Glavenus mit noch heißerem Schwert und explosiven Angriffen.', 'A deviant form of Glavenus with an even hotter blade and explosive attacks.'),
...
('Deviljho', 'Deviljho', 'dragon', 'power', 'jump', 'Verschiedene', 'Various', 'Ein ewig hungriger Tyrann der ganze Ökosysteme verschlingen kann.', 'An eternally hungry tyrant that can devour entire ecosystems.'),
...
-- === LEVIATHANS ===
('Royal Ludroth', 'Royal Ludroth', 'water', 'power', 'swim', 'Azuria', 'Azuria', 'Ein schwammiger Leviathan der Wasser in seiner Mähne speichert und es zur Verteidigung nutzt.', 'A spongy leviathan that stores water in its mane and uses it for defense.'),
('Purpur-Ludroth', 'Purple Ludroth', 'water', 'power', 'swim', 'Canalta-Waldland', 'Canalta Timberland', 'Eine giftigere Unterart des Royal Ludroth mit giftiger Mähne und Giftangriffen.', 'A more venomous subspecies of Royal Ludroth with a poisonous mane.'),
...
('Aurora Somnacanth', 'Aurora Somnacanth', 'ice', 'technical', 'swim', 'Serathis', 'Serathis', 'Eine Unterart des Somnacanth die in eisigen Gewässern lebt und Eisattacken einsetzt.', 'A subspecies of Somnacanth living in icy waters that uses ice attacks.'),
...
('Seelenblick Mizutsune', 'Soulseer Mizutsune', 'water', 'speed', 'swim', 'Serathis', 'Serathis', 'Eine abweichende Form des Mizutsune mit übernatürlichen Fähigkeiten und hellfire-infundierten Blasen.', 'A deviant form of Mizutsune with supernatural abilities and hellfire-infused bubbles.'),
...
('Ebenholz-Odogaron', 'Ebony Odogaron', 'dragon', 'speed', 'climb', 'Serathis', 'Serathis', 'Eine Unterart des Odogaron mit Drachenenergie und noch aggressiverem Verhalten.', 'A subspecies of Odogaron infused with dragon energy and even more aggressive behavior.'),
...
('Stygian Zinogre', 'Stygian Zinogre', 'dragon', 'technical', 'climb', 'Serathis', 'Serathis', 'Eine Variante des Zinogre die Drachenenergie statt Blitzenergie nutzt, angetrieben von Drachenbugs.', 'A variant of Zinogre that uses dragon energy instead of thunder, powered by Dragonbugs.'),
('Donnerherrscher Zinogre', 'Thunderlord Zinogre', 'thunder', 'power', 'climb', 'Canalta-Waldland', 'Canalta Timberland', 'Eine abweichende Form des Zinogre mit noch mächtigeren Blitzattacken und goldenem Blitzpanzer.', 'A deviant form of Zinogre with even more powerful thunder attacks and golden lightning armor.'),
...
('Königin der Schatten Rathian', 'Dreadqueen Rathian', 'fire', 'speed', 'fly', 'Tarkuan', 'Tarkuan', 'Eine abweichende Form der Rathian mit tödlichem Gift das sich schnell im Körper ausbreitet.', 'A deviant form of Rathian with deadly poison that spreads rapidly through the body.'),
...
('Blitzbrecher Astalos', 'Boltreaver Astalos', 'thunder', 'technical', 'fly', 'Serathis', 'Serathis', 'Eine abweichende Form des Astalos mit noch mächtigeren Blitzattacken und grünem Blitzschimmer.', 'A deviant form of Astalos with even more powerful thunder attacks and green lightning shimmer.'),
...
('Azurblauer Rathalos', 'Azure Rathalos', 'fire', 'power', 'fly', 'Canalta-Waldland', 'Canalta Timberland', 'Eine Unterart des Rathalos mit blauer Panzerung die mehr Zeit in der Luft verbringt.', 'A subspecies of Rathalos with blue armor that spends more time in the air.'),
('Schreckensfürst Rathalos', 'Dreadking Rathalos', 'fire', 'power', 'fly', 'Tarkuan', 'Tarkuan', 'Eine abweichende Form des Rathalos mit enormer Feuerkraft und königlicher Dominanz.', 'A deviant form of Rathalos with enormous firepower and regal dominance.'),
...
('Brutaler Tigrex', 'Brute Tigrex', 'none', 'power', 'climb', 'Tarkuan', 'Tarkuan', 'Eine Unterart des Tigrex mit noch lauteren Brüllern die Schockwellen erzeugen.', 'A subspecies of Tigrex with even louder roars that generate shockwaves.'),
('Grimmklaue Tigrex', 'Grimclaw Tigrex', 'none', 'power', 'climb', 'Serathis', 'Serathis', 'Eine abweichende Form des Tigrex mit massiveren Klauen und zerstörerischer Kraft.', 'A deviant form of Tigrex with more massive claws and destructive power.'),
...
('Schwarzer Diablos', 'Black Diablos', 'none', 'power', 'dive', 'Tarkuan', 'Tarkuan', 'Ein weiblicher Diablos in der Brunftzeit. Noch aggressiver als die normale Variante.', 'A female Diablos in heat. Even more aggressive than the normal variant.'),
...
('Großer Izuchi', 'Great Izuchi', 'bird_wyvern', 'thunder', 'Canalta-Waldland', 'Canalta Timberland', 'Der Anführer eines Izuchi-Trios mit mächtigem Schwanzangriff.', 'The leader of an Izuchi trio with a powerful tail attack.'),
...
('Purpur-Gypceros', 'Purple Gypceros', 'bird_wyvern', 'ice', 'Azuria', 'Azuria', 'Eine giftigere Variante des Gypceros mit violetter Färbung.', 'A more venomous variant of Gypceros with purple coloring.'),
...
('Einauge Yian Garuga', 'Deadeye Yian Garuga', 'bird_wyvern', 'thunder', 'Canalta-Waldland', 'Canalta Timberland', 'Eine abweichende Form des Yian Garuga, noch aggressiver.', 'A deviant form of Yian Garuga, even more aggressive.'),
...
('Blutorange Bishaten', 'Blood Orange Bishaten', 'fanged_beast', 'ice', 'Tarkuan', 'Tarkuan', 'Eine Unterart des Bishaten die mit explosiven Früchten angreift.', 'A subspecies of Bishaten that attacks with explosive fruits.'),
...
('Schemen-Nerscylla', 'Shrouded Nerscylla', 'temnoceran', 'fire', 'Serathis', 'Serathis', 'Eine Unterart der Nerscylla mit stärkerer Giftfähigkeit.', 'A subspecies of Nerscylla with stronger poison capability.'),
...
('Fulguranjanath', 'Fulgur Anjanath', 'brute_wyvern', 'water', 'Canalta-Waldland', 'Canalta Timberland', 'Eine Unterart des Anjanath die Blitzenergie nutzt.', 'A subspecies of Anjanath that uses thunder energy.'),
...
('Höllenschneide Glavenus', 'Hellblade Glavenus', 'brute_wyvern', 'water', 'Tarkuan', 'Tarkuan', 'Eine abweichende Form des Glavenus mit noch heißerem Schwert.', 'A deviant form of Glavenus with an even hotter blade.'),
...
('Royal Ludroth', 'Royal Ludroth', 'leviathan', 'fire', 'Azuria', 'Azuria', 'Ein schwammiger Leviathan der Wasser in seiner Mähne speichert.', 'A spongy leviathan that stores water in its mane.'),
('Purpur-Ludroth', 'Purple Ludroth', 'leviathan', 'fire', 'Canalta-Waldland', 'Canalta Timberland', 'Eine giftige Unterart des Royal Ludroth.', 'A venomous subspecies of Royal Ludroth.'),
...
('Aurora Somnacanth', 'Aurora Somnacanth', 'leviathan', 'thunder', 'Serathis', 'Serathis', 'Eine Unterart des Somnacanth mit Eisattacken.', 'A subspecies of Somnacanth with ice attacks.'),
...
('Seelenblick Mizutsune', 'Soulseer Mizutsune', 'leviathan', 'thunder', 'Serathis', 'Serathis', 'Eine abweichende Form des Mizutsune mit übernatürlichen Fähigkeiten.', 'A deviant form of Mizutsune with supernatural abilities.'),
...
('Ebenholz-Odogaron', 'Ebony Odogaron', 'fanged_wyvern', 'ice', 'Serathis', 'Serathis', 'Eine Unterart mit Drachenenergie und höherer Aggressivität.', 'A subspecies with dragon energy and higher aggression.'),
...
('Stygian Zinogre', 'Stygian Zinogre', 'fanged_wyvern', 'ice', 'Serathis', 'Serathis', 'Eine Variante die Drachenenergie statt Blitzenergie nutzt.', 'A variant using dragon energy instead of thunder.'),
('Donnerherrscher Zinogre', 'Thunderlord Zinogre', 'fanged_wyvern', 'ice', 'Canalta-Waldland', 'Canalta Timberland', 'Eine abweichende Form mit noch mächtigeren Blitzattacken.', 'A deviant form with even more powerful thunder attacks.'),
...
('Königin der Schatten Rathian', 'Dreadqueen Rathian', 'flying_wyvern', 'dragon', 'Tarkuan', 'Tarkuan', 'Eine abweichende Form mit tödlichem Schnellgift.', 'A deviant form with deadly rapid poison.'),
...
('Blitzbrecher Astalos', 'Boltreaver Astalos', 'flying_wyvern', 'water', 'Serathis', 'Serathis', 'Eine abweichende Form mit mächtigeren Blitzattacken.', 'A deviant form with more powerful thunder attacks.'),
...
('Azurblauer Rathalos', 'Azure Rathalos', 'flying_wyvern', 'dragon', 'Canalta-Waldland', 'Canalta Timberland', 'Eine Unterart die mehr Zeit in der Luft verbringt.', 'A subspecies that spends more time in the air.'),
('Schreckensfürst Rathalos', 'Dreadking Rathalos', 'flying_wyvern', 'dragon', 'Tarkuan', 'Tarkuan', 'Eine abweichende Form mit enormer Feuerkraft.', 'A deviant form with enormous firepower.'),
...
('Brutaler Tigrex', 'Brute Tigrex', 'flying_wyvern', 'thunder', 'Tarkuan', 'Tarkuan', 'Eine Unterart mit ohrenbetäubenden Brüllern.', 'A subspecies with deafening roars.'),
('Grimmklaue Tigrex', 'Grimclaw Tigrex', 'flying_wyvern', 'thunder', 'Serathis', 'Serathis', 'Eine abweichende Form mit massiveren Klauen.', 'A deviant form with more massive claws.'),
...
('Schwarzer Diablos', 'Black Diablos', 'flying_wyvern', 'ice', 'Tarkuan', 'Tarkuan', 'Ein weiblicher Diablos in der Brunftzeit, noch aggressiver.', 'A female Diablos in heat, even more aggressive.'),
